...
def getJsonFromBLDAS(request):
    # for public tethys
    # url = 'https://tethys.icimod.org/apps/bldas-explorer/api/getMaskedPolygonStatsRangePost/'
...
def getAreaUnderFromBLDAS(request):
    # for public tethys
    # url = 'https://tethys.icimod.org/apps/bldas-explorer/api/getMaskedPolyAreaRangePost/'
